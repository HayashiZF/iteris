...
This document explains how the repository works end-to-end and where to edit code for each workflow stage.
...
Use this area when you want the repo's workflows exposed as portable Codex skills rather than only as the Python CLI.
